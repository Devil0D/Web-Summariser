...
logging.set_verbosity_error()  # silence HF model logs
...
def bart_summary(text: str) -> str:
    ...
    # Token-based ratio instead of fixed numbers
    input_length = len(text.split())
    min_len = max(25, input_length // 4)   # at least 1/3rd, but not too short
    max_len = max(min_len + 20, input_length // 2)  # up to 1/2
